...
mod fastcoin_tests {
    ...
    use self::fastcoin::kraken::KrakenCreds;
    use self::fastcoin::bitstamp::BitstampCreds;
    use self::fastcoin::poloniex::PoloniexCreds;
    ...
    fn can_create_new_api_connection_to_bitstamp() {
        ...
        let api: Box<ExchangeApi> = Fastcoin::new(Exchange::Bitstamp, creds).unwrap();
    ...
    fn fastcoin_can_get_a_ticker_from_bitstamp() {
        let creds = BitstampCreds::new("test", "bs_api_key", "bs_api_secret", "bs_cust_id");
        let mut api = Fastcoin::new(Exchange::Bitstamp, creds).unwrap();
    ...
    fn fastcoin_can_get_a_ticker_from_kraken() {
        ...
        let mut api = Fastcoin::new(Exchange::Kraken, creds).unwrap();
    ...
    fn fastcoin_can_get_a_ticker_from_poloniex() {
        ...
        let mut api = Fastcoin::new(Exchange::Poloniex, creds).unwrap();
    ...
    #[test]
    fn fastcoin_can_get_an_orderbook_from_bitstamp() {
    ...
    fn fastcoin_can_get_the_balances_from_poloniex() {
        let path = PathBuf::from("./keys_real.json");
    ...
    #[test]
    #[cfg_attr(not(feature = "bitstamp_private_tests"), ignore)]
    fn fastcoin_can_get_at_least_a_positive_balance_from_bitstamp() {
        let path = PathBuf::from("./keys_real.json");
        let mut api = Fastcoin::new_from_file(Exchange::Bitstamp, "account_bitstamp", path)
            .unwrap();
        let balances: Balances = api.balances().unwrap();
    ...
    fn fastcoin_can_get_the_balances_from_kraken() {
        let path = PathBuf::from("./keys_real.json");
    ...
    #[test]
    #[cfg_attr(not(feature = "poloniex_private_tests"), ignore)]
    fn fastcoin_can_get_at_least_a_positive_balance_from_poloniex() {
        let path = PathBuf::from("./keys_real.json");
        let mut api = Fastcoin::new_from_file(Exchange::Poloniex, "account_poloniex", path)
            .unwrap();
        let balances: Balances = api.balances().unwrap();
